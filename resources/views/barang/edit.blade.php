            ...
            <div class="page-title-box">
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item  breadcrumb-link"><a class="breadcrumb-link text-hover-color-scheme"  href="{{route('barang.index')}}">List Barang/Obat</a></li>

                  <li class="breadcrumb-item  breadcrumb-link active">Edit Barang/Obat</li>
                </ol>
              </div>
              <div class="row">
                <div class="col-lg-2">
                    <a href="{{route('barang.index')}}" ><h4 class="page-title back-button  text-hover-color-scheme"><i class="mdi mdi-arrow-left"></i> Back</h4> </a>
                </div>
              </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <h4 class="header-title" style="padding-bottom:20px;">Edit Barang/Obat</h4>
                ...
                @endif
                <form id="edit_barang" action="{{ route('barang.update',['id'=>$data->id]) }}"
                      enctype="multipart/form-data" method="POST">
                      {{ csrf_field() }}

                  <div class="row mb-3">
                    <label for="keterangan" class="col-5 col-xl-4 col-form-label"  style="color:#6D757D">Keterangan
                    ...
                    <div class="col-8 col-xl-8">
                      <input type="text" id="keterangan" name="keterangan" class="form-control" value="{{$data->keterangan}}" style="color:#333333;" required>
                    </div>
                  ...
                  <div class="row mb-3">
                    <label for="harga" class="col-5 col-xl-4 col-form-label"  style="color:#6D757D">Harga Satuan (Rp)
                      <!--<i class="mdi mdi-information" title="Put cursor at pie chart to view number" tabindex="0"
                        data-plugin="tippy" data-tippy-theme="translucent"></i>-->  </label>
                    <div class="col-8 col-xl-8">
                      <input type="number" id="harga" name="harga" class="form-control" value="{{(int) $data->harga}}" style="color:#333333;"  required>
                    </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-8 col-xl-8">
                      <button type="submit" id="edit_barang_btn" class="btn btn-danger waves-effect waves-light col-12 col-xl-8" ><i class="fas fa-plus-square"></i>&#160; Edit Barang/Obat
                      </button>
                      <a href="{{route('barang.index')}}" class="btn btn-light waves-effect col-3 col-xl-3"
