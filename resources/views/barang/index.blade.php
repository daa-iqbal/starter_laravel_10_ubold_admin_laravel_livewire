@extends('layouts.app')
@section('title')
  <title>List Barang/Produk</title>
@endsection
@section('style')
  <!-- third party css -->
              ...
              <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item  breadcrumb-link active"><a class="breadcrumb-link text-hover-color-scheme"  href="{{route('barang.index')}}">List Barang</a></li>
                    </ol>
                </div>
                <h4 class="page-title">List Barang/Produk</h4>
              </div>
            </div>
          </div>
                    ...
                    <div class="row">
                      <div class="btn-toolbar" style="padding-bottom:8px">
                        ...
                        <div class="btn-group dropdown-btn-group pull-right" style="padding-bottom:20px;">
                            <a href="{{ route('barang.create')}}" class="btn  button-hover-color-scheme"> <i class="fas fa-plus-square"></i>&#160;  Add New Data</a>
...
@section('script')
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      let url = "{{ route('barang.datatable') }}";
        ...
        columns: [
...

                {
                    ...
                    render: function(data){
                        let linkEdit = "{{route('barang.edit', ':id')}}";
                        linkEdit = linkEdit.replace(':id', data.id);
                        let linkDelete = "{{route('barang.delete', ':id')}}";
                        ...
                        let aksi = '<div class="dropdown float-end">'+
                                        ...
                                        '<div class="dropdown-menu dropdown-menu-end">'+
                                            ...
                                            '<a  href="javascript:void(0);" class="dropdown-item btndelete" fullname="'+data.keterangan+'" dataid="'+data.id+'" style="float: none;"><!--<span class="mdi mdi-delete"></span>--> Delete</a>'+
    ...
    $(document).delegate('.btndelete','click', function () {
      ...
      let labelDelete = 'Hapus Barang/Obat';
      let contentParagraphDelete = "Apakah anda yakin akan menghapus data barang/obat ini </br>" + "<b>"+"'"+fullname+"'"+"</b>"+"?";
      let yesDelete = "Hapus Barang/Obat";
