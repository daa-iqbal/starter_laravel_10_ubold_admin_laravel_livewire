            ...
            <div class="page-title-box">
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item  breadcrumb-link active">Add New Barang/Obat</li>
                </ol>
              </div>
              <div class="row">
                <div class="col-lg-2">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <h4 class="header-title" style="padding-bottom:20px;">Add New Barang/Obat</h4>
                ...
                @endif
                <form id="add_barang" action="{{ route('barang.store') }}"
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-8 col-xl-8">
                      <input type="text" id="keterangan" name="keterangan" class="form-control" value="" style="color:#333333;" required>
                    </div>
                  ...
                  <div class="row mb-3">
                    <label for="harga" class="col-5 col-xl-4 col-form-label"  style="color:#6D757D">Harga Satuan (Rp)
                      <!--<i class="mdi mdi-information" title="Put cursor at pie chart to view number" tabindex="0"
                        data-plugin="tippy" data-tippy-theme="translucent"></i>-->  </label>
                    <div class="col-8 col-xl-8">
                      <input type="number" id="harga" name="harga" class="form-control" value="" style="color:#333333;"  required>
                    </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-8 col-xl-8">
                      <button type="submit" id="add_barang_btn" class="btn btn-danger waves-effect waves-light col-12 col-xl-8" ><i class="fas fa-plus-square"></i>&#160; Add New Barang/Obat
                      </button>
