              ...
              <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item  breadcrumb-link active"><a class="breadcrumb-link text-hover-color-scheme"  href="{{route('invoice.index')}}">List Invoice</a></li>
                    </ol>
                </div>
                      ...
                      <div class="col-sm-12">
                        <table id="datatable"
                          ...
                          <tr>
                            ...
                            <th valign="middle" >Kode Invoice</th>
                            <th valign="middle" >Pasien</th>
