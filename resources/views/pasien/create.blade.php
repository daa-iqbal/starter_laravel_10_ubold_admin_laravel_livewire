            ...
            <div class="page-title-box">
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item  breadcrumb-link active">Add New Pasien</li>
                </ol>
              </div>
              <div class="row">
                <div class="col-lg-2">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <h4 class="header-title" style="padding-bottom:20px;">Add New Pasien</h4>
                ...
                @endif
                <form id="add_pasien" action="{{ route('pasien.store') }}"
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-8 col-xl-8">
                      <input type="text" id="name" name="name" class="form-control" value="" style="color:#333333;" required>
                    </div>
                  </div>
                  <div class="row mb-3">
                    ...
                    <div class="col-8 col-xl-8">
                      <input type="email" id="email" name="email" class="form-control" value="" style="color:#333333;" required>
                    </div>
                  </div>
                  <div class="row mb-3">
                    ...
                    <div class="col-8 col-xl-8">
                      <input type="text" id="phone" name="phone" class="form-control" value="" style="color:#333333;" required>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label class="col-5 col-xl-4 form-label"></label>
                    <div class="col-8 col-xl-8">
                      <button type="submit" id="add_pasien_btn" class="btn btn-danger waves-effect waves-light col-12 col-xl-8" ><i class="fas fa-plus-square"></i>&#160; Add New Pasien
                      </button>
